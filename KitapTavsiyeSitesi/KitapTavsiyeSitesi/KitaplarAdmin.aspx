<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="KitaplarAdmin.aspx.cs" Inherits="KitapTavsiyeSitesi.KitaplarAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" BackColor="#00CC99">
        <table class="auto-style1">
            <tr>
                <td class="auto-style15">KİTAP LİSTESİ</td>
                <td>
                ...
                <table class="auto-style1">
                    <tr>
                        ...
                        <td class="auto-style6">
                            <a href="KitaplarAdmin.aspx?Kitapid=<%#Eval("Kitapid") %>&islem=sil">
                                <asp:Image ID="Image2" runat="server" Height="33px" Width="31px" ImageUrl="~/Resimler/çarpıikonu.png" /></a>
                        </td>
                        <td class="auto-style6">
                            <a href="KitapGuncelle.aspx?Kitapid=<%#Eval("Kitapid")%>">
                                <asp:Image ID="Image3" runat="server" Height="30px" Width="31px" ImageUrl="~/Resimler/detayikonu.png" /></a>
                        </td>
                    </tr>
                </table>
            </ItemTemplate>
    ...
    <asp:Panel ID="Panel4" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                <td>KİTAP YAZAR:</td>
                <td>
                    <asp:TextBox ID="TextBox2" runat="server" Height="80px" TextMode="MultiLine" Width="352px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>KİTAP KONU:</td>
